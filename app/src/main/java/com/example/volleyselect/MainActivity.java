...
public class MainActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public static final String URL = "https://websensordata.000webhostapp.com/android/select.php";
    //public static final String URL = "http://192.168.1.5:8080/kampus/android/select.php";
